...
export default async function HomePage() {
  ...
  const sectionClassName = "py-10 sm:py-12";
  ...
  return (
    <main>
      ...
      <section className="relative isolate overflow-hidden bg-black text-white">
        ...
        <div className="shell relative z-10 grid min-h-[calc(100vh-80px)] items-center gap-8 py-10 sm:py-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="relative">
            ...
            <h1 className="hero-animate hero-animate-delay-2 mt-3 max-w-4xl font-display text-5xl font-semibold leading-[1.04] tracking-[-0.32px] sm:text-7xl">
              Bất Động Sản Phía Đông Hà Nội
            </h1>
            <p className="hero-animate hero-animate-delay-3 mt-3 max-w-2xl text-[17px] font-normal leading-[1.47] tracking-[-0.374px] text-[#f5f5f7]">
            ...
            <div className="hero-animate hero-animate-delay-4 mt-5 flex flex-wrap gap-2">
          ...
          <div className="hero-animate hero-animate-delay-4 rounded-[28px] bg-[#1d1d1f]/78 p-5 backdrop-blur-sm">
            ...
            {featuredLandListings.map((item) => {
              ...
              return (
                <Link
                  key={item.id}
                  href={cardItem.href}
                  className="group grid gap-3.5 overflow-hidden rounded-[28px] border border-line bg-white p-4.5 transition hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(15,23,42,0.08)] md:grid-cols-[248px_1fr]"
                >
                  ...
                  <div className="flex flex-col gap-2.5 md:py-0.5">
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        ...
                        <h3 className="mt-2.5 font-display text-[34px] leading-[1.08] tracking-[-0.28px] text-ink">{cardItem.name}</h3>
      ...
      <section className={`bg-white ${sectionClassName} text-ink`}>
        <div className={sectionInnerClassName}>
          ...
          <div className="overflow-hidden rounded-[18px] border border-line bg-white">
            <div className="hidden grid-cols-[88px_1.1fr_0.95fr_0.9fr_0.8fr_0.7fr] gap-4 border-b border-line bg-[#fbfbfd] px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-steel lg:grid">
              <span>Ảnh</span>
              <span>Khu vực</span>
              <span>Diện tích</span>
              <span>Loại hình</span>
            ...
            <div className="divide-y divide-line">
              {featuredRentals.length ? (
                featuredRentals.map((item) => (
                  ...
                  >
                    <div className="grid gap-3 px-5 py-3.5 lg:grid-cols-[88px_1.1fr_0.95fr_0.9fr_0.8fr_0.7fr] lg:items-center">
        ...
        <div className={sectionInnerClassName}>
          ...
          {latestPost ? (
            <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
              ...
              <div className="grid content-start gap-x-4 gap-y-6 sm:grid-cols-2">
      ...
      <section className="bg-white py-10 sm:py-12">
        <div className={sectionInnerClassName}>
          <div className="rounded-[32px] border border-line bg-[#f5f5f7] p-6 sm:p-8">
            <p className="eyebrow">Liên hệ nhanh</p>
            <div className="mt-2.5 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                <h2 className="font-display text-5xl text-ink">Cần tư vấn nhanh về dự án phía Đông Hà Nội?</h2>
                <p className="mt-2.5 text-[17px] leading-[1.47] tracking-[-0.374px] text-steel">
