        ...
        <div className="mt-auto border-t border-[#eceff3] pt-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link
              ...
              className="inline-flex rounded-full border border-[#0066cc] px-4 py-2 text-sm font-medium tracking-[-0.224px] text-[#0066cc] transition hover:bg-[#0066cc] hover:text-white"
            >
              Xem chi tiết
            </Link>
          </div>
